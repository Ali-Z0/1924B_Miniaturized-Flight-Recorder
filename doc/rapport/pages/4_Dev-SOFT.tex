...
Avant d'avoir le \gls{pcb} monté et exploitable, sachant que nous connaissons le protocole par défaut du module, nous pouvons analyser des données \textbf{NMEA} pour mieux les comprendre et les traiter par la suite. Pour se faire, le site \href{https://www.nmeagen.org/}{https://www.nmeagen.org/}, permet de générer des coordonnées avec le protocole \textbf{NMEA}.
