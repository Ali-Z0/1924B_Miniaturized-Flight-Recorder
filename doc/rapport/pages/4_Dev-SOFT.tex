...
TKinter permet d’utiliser des objet/widgets pour facilement mettre en place une interface graphique de façon très intuitive.\vspace*{-4mm}

\begin{figure}[h]
	\centering
	\includegraphics[width=.85\linewidth]{../figures/application/tkinter}
