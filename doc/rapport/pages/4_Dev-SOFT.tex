...
\begin{figure}[!h]
	\centering
	\includegraphics[width=.66\linewidth]{../figures/code/diagrammes/sequence-app}
...
\clearpage
\subsubsection{Etat logging}
asdjaoisd asj doajsdoiasjd jaisdj aisjd ioasjd oasjd oaisjd aisjd iasjd oi

\begin{figure}[!h]
	\centering
	\includegraphics[width=.94\textwidth]{../figures/code/diagrammes/logging-flowchart}
