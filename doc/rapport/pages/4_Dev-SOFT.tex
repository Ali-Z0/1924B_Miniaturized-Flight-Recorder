...
\begin{equation*}
	C_{T1} = \frac{f_{sys}}{f_{per}*presc} - 1 = \frac{48*10^{6}}{1*10^{3}} - 1 = 47'999\;[-]
\end{equation*}
...
\begin{equation*}
	C_{T1} = \frac{f_{sys}}{f_{per}*presc} - 1 = \frac{48*10^{6}}{100*16} - 1 = 29'999\;[-]
\end{equation*}

\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=.4\linewidth]{../figures/code/harmony/timers}}
