...
\begin{table}[!h]
	\centering
		\begin{tabular}{|lll|}
			...
			& \faChevronRight & Signaux proche du \gls{mcu}.     \\
			& \faChevronRight & Signaux sortant du \gls{gnss}.   \\
			& \faChevronRight & Pistes horizontales.             \\
			& \faChevronRight & Plan de masse.                   \\
			& \faChevronRight & Connecteurs boutons et batterie. \\ \hline
			\textbf{LAYER 1} &                 &                                  \\
			& \faChevronRight & Piste de signaux verticales.     \\
			...
			& \faChevronRight & Piste signaux verticales.        \\
			& \faChevronRight & Plan de masse.                   \\ \hline
		\end{tabular}%
	\caption{Descriptions des éléments du routage}
